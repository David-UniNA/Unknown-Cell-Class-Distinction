...
beta_values = np.linspace(0.0, 1, 11)                                       # Generate an array of beta values from 0.0 to 0.5
...
(X_INI, Y_INI),(X_val, Y_val) = load_dataset(input_folder, dim, execute_split=True)# Load the dataset. Set execute_split to True if you want to split the dataset, otherwise False.
