...
def load_dataset(input_folder, dim, output_folder=None, seed=1337, execute_split=False):
    ...
    # 'seed 1337' refers to setting the seed for a random number generator to a fixed value, in this case, 1337. This ensurs that the sequence of random numbers generated is reproducible.
    # This is useful in data science when you want to ensure that results can be consistently replicated, such as when splitting datasets or initializing weights in neural networks
        
## Check if the user wants to execute the split command
    if execute_split:                                                       # It automatically organizes files into respective folders named train, val and test.
...
## Load the validation data
    ...
    dataTRAIN = []                                                          # Initialize a list to hold the trained data images.
    labelsTRAIN = []                                                        # Initialize a list to hold the training labels.
    dataVAL = []                                                            # Initialize a list to hold the validation data images.
    labelsVAL = []                                                          # Initialize a list to hold the validation labels.
