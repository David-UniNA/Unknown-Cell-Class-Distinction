...
def plot_tsne(X_data, Y_data, title, n_components=3, perplexity=100.0, early_exaggeration=10.0, random_state=123, save_path=None):
    ...
    """
    X_reshaped = X_data.reshape(X_data.shape[0], -1)            # Reshapes the input data into a 2D array for t-SNE processing.
    ...
    sns.scatterplot(x="tSNE - comp 1", y="tSNE - comp 2", hue=df.y.tolist(),
